...
<c:url var="addAction" value="/books/read"/>
...
<form:form action="${addAction}" commandName="book">
    <table class="features-table">
        ...
        <tr>
            ...
            <td>
                <form:checkbox path="readAlready" value="${book.readAlready}" checked="checked"/>
            </td>
        </tr>

        <tr>
            <td colspan="2" style="text-align: center">
                <input type="submit" value="<spring:message text="Book is already read"/>"/>
            </td>
        </tr>
    </table>
</form:form>
